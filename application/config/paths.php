...
define('IMAGE', BASEURL . 'assets/images/');
...
define('MUSTACHE_FOLDER','application/modules/mail/views/views');
define('ICONS', IMAGE . 'icons/');
define('DIRECTORY_IMAGES', $_SERVER['DOCUMENT_ROOT'] . '/bdeal.comDesignV2/assets/uploads/userProfileImages');
